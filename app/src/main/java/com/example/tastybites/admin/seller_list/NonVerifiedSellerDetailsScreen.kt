package com.example.tastybites.admin.seller_list
...
fun AdminSellerScreen(
    ...
    val viewModel : AdminViewModel = hiltViewModel()
    val backgroundImage: Painter = painterResource(id = R.drawable.ic_launcher_background) // Replace with your background image
    Box(
